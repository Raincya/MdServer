...
class Notes
{
  public:
    struct Cols
    {
        ...
        static const std::string _update_date;
    };
     ...
     */
    explicit Notes(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Notes(const Json::Value &pJson) noexcept(false);
     ...
     */
    Notes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column update_date  */
    ///Get the value of the column update_date, returns the default value if the column is null
    const ::trantor::Date &getValueOfUpdateDate() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getUpdateDate() const noexcept;
    ///Set the value of the column update_date
  ...
  private:
    friend drogon::orm::Mapper<Notes>;
    friend drogon::orm::BaseBuilder<Notes, true, true>;
    friend drogon::orm::BaseBuilder<Notes, true, false>;
    friend drogon::orm::BaseBuilder<Notes, false, true>;
    friend drogon::orm::BaseBuilder<Notes, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Notes>;
#endif
